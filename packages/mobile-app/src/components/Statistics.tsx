      ...
      <View style={styles(colors).statisticsContent}>
        ...
        <View style={styles(colors).statItem}>
          <View style={styles(colors).statIconAccuracy}>
            <Text style={styles(colors).statIconAccuracyText}>
              {stats.passed ? "👍" : "😔"}
            </Text>
          </View>
          <Text
            style={[
              styles(colors).statNumber,
              stats.passed
        ...
        <View style={styles(colors).buttonsGroup}>
          <TouchableOpacity
            style={[
              ...
              showAnswers ? styles(colors).toggleButtonActive : null,
            ]}
        ...
        <View style={styles(colors).progressBar}>
          <View
            style={[
              ...
              {
                width: `${(stats.totalAnswered / (stats.totalVisible || 1)) * 100}%`,
              },
            ]}
          />
        </View>
