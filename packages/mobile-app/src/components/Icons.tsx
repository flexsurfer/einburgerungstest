...
type DirectionalIconProps = IconProps & { isRtl?: boolean };
type ArrowIconProps = { color: string; isRtl?: boolean };

export const LeftArrow = ({ color, isRtl = false }: ArrowIconProps) => (
  <Svg
    width={20}
    height={20}
    viewBox="0 0 24 24"
...
export const RightArrow = ({ color, isRtl = false }: ArrowIconProps) => (
  <Svg
    width={20}
    height={20}
    viewBox="0 0 24 24"
  ...
  >
    <Path
      d={isRtl ? "M15 18L9 12L15 6" : "M9 18L15 12L9 6"}
      stroke={color}
      strokeWidth={2}
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ArrowRight = ({
  ...
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d={isRtl ? "M19 12H5M10 7l-5 5 5 5" : "M5 12h14M14 7l5 5-5 5"}
      stroke={color}
      strokeWidth={2}
      strokeLinecap="round"
      strokeLinejoin="round"
